...
const Manage_Project_2 = ({ setLoginUser }) => {
    ...
    const move_to_next_step = () => {
        navigate("../manage_project_3?proj_id=" + project_id + "&&p_name=" + project_name);
    }
                    ...
                    <tr>
                        <td id="left_panel">
                            ...
                            <p id="json_type_prop_display">
                                <span className="glyphicon glyphicon-hand-right"></span>&nbsp;<b>Action Response JSON</b><hr />
                                <div id="json_props">
...
export default Manage_Project_2