...
const Manage_Project_3 = ({ setLoginUser }) => {
    ...
    const move_to_next_step = () => {
         // navigate("../manage_project_4?proj_id=" + project_id + "&&p_name=" + project_name);
        window.location.href = "http://localhost:5173/?p_name="+project_name+"&&proj_id="+project_id;
    }
                    ...
                    <tr>
                        <td id="left_panel">
                            ...
                            <p id="json_type_prop_display">
                                <span className="glyphicon glyphicon-hand-right"></span>&nbsp;<b>Asset JSON</b><hr />
                                <div id="json_props">
...
export default Manage_Project_3